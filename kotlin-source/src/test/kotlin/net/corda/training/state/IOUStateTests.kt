...
class IOUStateTests {
    ...
    fun checkPayHelperMethod() {
        ...
        assertEquals(0.POUNDS, iou.pay(5.POUNDS).paid)
        assertEquals(0.POUNDS, iou.pay(1.POUNDS).pay(2.POUNDS).paid)
        assertEquals(0.POUNDS, iou.pay(5.POUNDS).pay(3.POUNDS).pay(2.POUNDS).paid)
    }
